	...
	<header data-bs-theme="dark">
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.jsp">Cidadania+</a>
          <button
          ...
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="perfil.jsp">Cadastro</a>
              </li>
              <li class="nav-item"><a class="nav-link" href="denuncia.jsp">Denúncia</a></li>
              <li class="nav-item">
                <a class="nav-link" href="listarUsuarios.jsp">Listar contas</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="historico.jsp">Histórico</a>
              </li>
              <li class="nav-item">
